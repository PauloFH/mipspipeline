	...
	void aluOperation()
	{
		...
		else
		{
			...
			case slt_op:
				...
				output_value.write(internResult);
				cout << "SLT comparação entre " << internDataA << " e " << internDataB << "resultou em: " << zero.read() << endl;
			...
			case bne_op:
				...
				cout << "salto condicional " << internDataA << " e " << internDataB << "resultou em: " << zero.read() << endl;
				break;
				

			case lw_op:
				cout << "lw origem " << internDataA << " + " << internDataB << "resultou em: " << internResult << endl;
				internResult = internDataA + internDataB;
				output_value.write(internResult);
				break;
			case sw_op:
				...
				internResult = internDataA + internDataB;
				output_value.write(internResult);
				cout << "sw destino " << internDataA << " + " << internDataB << "resultou em: " << internResult << endl;
